...
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind1]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind2]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind3]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=ServiceProvider]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind4]
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind5]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind6]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind7]
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind8]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyWorker.java[tags=MyWorker]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/Marker.java[tags=Marker]
----

[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyServiceProvider.java[tags=Bind9]
----

[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/MyWorker.java[tags=MyWorker2]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/generics/Generics.java[tags=Bind]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/collections/MyModule.java[tags=MyModule]
----
...
[source,java,indent=0]
----
include::../../../../test/java/io/bootique/di/docs/bootiqueDI/binder/optional/MyModule.java[tags=MyModule]
----
